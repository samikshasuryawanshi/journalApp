...
export default function Dashboard({ onLogout }) {
  ...
  const handleLogout = async () => {
    ...
    if (window.indexedDB) {
      ...
      DBDeleteRequest.onsuccess = () => console.log('IndexedDB deleted');
      DBDeleteRequest.onerror = () => console.log('Error deleting IndexedDB');
      DBDeleteRequest.onblocked = () => console.log('Delete blocked');
    }
    onLogout();
  };
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-7 font-sans min-h-screen">
        <div className="flex justify-between items-center mb-6">
          <div>
          <h1
            className="text-3xl sm:text-3xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-indigo-600 drop-shadow-md mb-5"
          >
             Welcome to Moody
          </h1>
        ...
        <div className="flex justify-start mb-4">
          <button
            className={`px-4 py-2 rounded-full  active:scale-95 text-white font-medium transition ${
        ...
        {showCalendar ? (
          ...
          <>
            <div ref={formRef}>
              <EntryForm refreshEntries={refreshEntries} selectedDate={selectedDate} />
            </div>
